...
public class Quadrant
{
    public static void main( String[] args) {
       ...
       double y;
        ...
        System.out.println("enter an x-coordinate here");  //prompt the user for an x-coordinate
        x = keys.nextDouble();
        System.out.println("enter a y-coordinate here");  //prompt the user for a y-coordinate
        y = keys.nextDouble();
        keys.close();
